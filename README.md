...
- Import path: `gnalloy.org/codec-spdy`
- Repository: `github.com/gnalloy/codec-spdy`
- Default branch: `dev`
- Preview install: `go get gnalloy.org/codec-spdy@dev`
- License: Apache-2.0

## Install
```bash
go get gnalloy.org/codec-spdy@dev
go doc gnalloy.org/codec-spdy
...
This repository owns: SPDY frame codec support for legacy protocol interop in Gnalloy pipelines.
...
- SPDY is legacy interoperability support and should not be selected for new public deployments unless a peer still requires it.
