# ADR-001: Keep codec-spdy as an Independent Gnalloy Module
...
`codec-spdy` is published as `gnalloy.org/codec-spdy` and owns this responsibility: SPDY frame codec support for legacy protocol interop in Gnalloy pipelines.
